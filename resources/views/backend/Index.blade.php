    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden">
                <div class="p-6">
                    <div class="grid grid-cols-4 items-end gap-5 text-gray-600">
                        <div class="bg-white p-5 rounded-md border-l-4 border-t-4 border-blue-500 flex justify-between items-center">
                        ...
                        <div class="bg-white p-5 py-7 rounded-md border-t-4 border-red-500 flex justify-between items-center">
                            <p class="font-bold">
                        ...
                        <div class="bg-white p-5 py-7 rounded-md border-t-4 border-orange-500 flex justify-between items-center">
                            <p class="font-bold">
                        ...
                        <div class="bg-white p-5 rounded-md border-r-4 border-t-4 border-green-500 flex justify-between items-center ">
                            <p class="font-bold">

                     ...
                     <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-6 col-xl-9 order-2 order-lg-2">
                           ...
                           <div class="card-text ">
                              ...
                              <div>
                              <div class=" bg-gray-100 roundy px-0 py-1 mr-0 mr-lg-1 mt-1 mt-lg-0" style="width: 30%; float:left"><i class="fa-solid fa-phone fa-md" style="margin-right: 10px;"></i>{{ $r->contact->extension }}</div>
                              <div class="bg-gray-100 roundy px-0 py-1 mr-0 mr-lg-1 mt-1 mt-lg-0" style="width: 70%; float:right;"><i class='fa fa-mobile-phone fa-lg' style="margin-right: 10px;" ></i> {{ $r->contact->mobile }}</div>
                              </div>
                              <div class="bg-gray-100 roundy px-0 py-1 mr-0 mr-lg-1 mt-1 mt-lg-0"><i class="fa-solid fa-envelope" style="margin-right: 10px;"></i> {{ $r->contact->email }}</div>
                           </div>
